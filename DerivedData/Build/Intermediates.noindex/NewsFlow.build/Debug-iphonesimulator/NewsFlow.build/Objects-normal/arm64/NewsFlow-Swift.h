...
#ifndef NEWSFLOW_SWIFT_H
#define NEWSFLOW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NewsFlow",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ReadingListItem")
@interface ReadingListItem : NSManagedObject
@property (nonatomic, copy) NSString * _Nonnull id;
@property (nonatomic, copy) NSString * _Nonnull title;
@property (nonatomic, copy) NSString * _Nullable articleDescription;
@property (nonatomic, copy) NSString * _Nullable url;
@property (nonatomic, copy) NSString * _Nullable urlToImage;
@property (nonatomic, copy) NSDate * _Nullable publishedAt;
